...
final GoRouter router =
  ...
  GoRoute(
      path: AppRoutes.login.path, builder: (context, state) => SignInScreen()),
  GoRoute(
      path: AppRoutes.signup.path, builder: (context, state) => SignupPage()),
  GoRoute(
      path: AppRoutes.onboarding.path,
      builder: (context, state) => OnboardingScreen()),
  GoRoute(path: AppRoutes.home.path, builder: (context, state) => HomePage()),
  GoRoute(path: AppRoutes.otp.path, builder: (context, state) => OtpScreen()),
  GoRoute(
  ...
  GoRoute(
      path: AppRoutes.donors.path, builder: (context, state) => DonorsPage()),
  GoRoute(path: AppRoutes.map.path, builder: (context, state) => MapScreen()),
  GoRoute(
      path: AppRoutes.splash.path, builder: (context, state) => SplashScreen()),
  GoRoute(
